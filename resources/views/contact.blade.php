                ...
                <div class="col-xxl-6 col-xl-8 col-lg-8">
                    <div class="rs-breadcrumb-content-wrapper">
                        <div class="rs-breadcrumb-title-wrapper">
                            <h1 class="rs-breadcrumb-title">Contactez-nous</h1>
                        </div>
            ...
            <div class="row  g-5 justify-content-center section-title-space align-items-center">
                <div class="col-xl-7 col-lg-7 col-md-8">
                    <div class="rs-section-title-wrapper text-center">
                        ...
                        <h2 class="rs-section-title rs-split-text-enable split-in-fade mb-10">Entrez en contact avec nos
                            équipes</h2>
                        <p>Nous sommes à votre disposition pour répondre à toutes vos questions et vous assister dans tous
                            vos projets.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="rs-contact-wrapper">
                        <div class="rs-contact-thumb">
                            <img src="{{ asset('assets/images/contact/contact-thumb-05.png') }}" alt="image">
                        </div>
                    ...
                    <div class="rs-contact-wrapper">
                        <div class="rs-contact-item">
                            ...
                            <div class="rs-contact-content">
                                <h5 class="rs-contact-title">Notre Adresse </h5>
                                <a href="#">257, Av. Nyunzu, Q/ Baudouin, C/ Lubumbashi, Haut-Katanga, RDC</a>
                            </div>
                        </div>
                        ...
                        <div class="rs-contact-item">
                            ...
                            <div class="rs-contact-content">
                                <h5 class="rs-contact-title">Heures d'ouverture </h5>
                                <p> Lun - Sam 07:30 - 17:30 <br>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-md-12">
                                    <div class="rs-contact-btn">
                                        <button type="submit" class="rs-btn has-theme-orange">Envoyer</button>
                                    </div>
                                </div>
                            </div>
                        </form>
