...
<body class="rs-smoother-yes">
    ...
    <div id="pre-load">
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class="loader-icon"><img src="{{ asset('assets/images/favicon.png') }}" alt=""></div>
            </div>
        </div>
    </div>
    <!-- preloader end -->
                ...
                <div class="rs-header-inner">
                    ...
                    <div class="rs-header-right">
                        ...
                        <div class="rs-header-btn">
                            <a class="rs-btn has-theme-orange has-icon has-bg" href="{{ route('contact') }}">Entrez en
                                contact
                                <span class="icon-box">
            ...
            <div class="container-fluid g-0">
                <div class="rs-header-inner">
                    ...
                    <div class="rs-header-right">
                        ...
                        <!-- search area end -->
                        <div class="rs-header-btn">
                            <a class="rs-btn has-theme-orange has-icon has-bg" href="{{ route('contact') }}">Entrez
                                en contact
                                <span class="icon-box">
                                    <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                        <path
                        ...
                        <ul>
                            <li class="d-flex align-items-center gap-15">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="#"> 18, Av. du Cobalt, Q/ Makomeno, C/ Lubumbashi, Haut-Katanga, RDC
                                    </a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center gap-15">
    ...
    <footer class="rs-footer-area rs-footer-one black-bg">
        <div class="rs-footer-bg-thumb" data-background="{{ asset('assets/images/bg/footer-bg-01.png') }}"></div>
        <div class="container">
                ...
                <div class="rs-footer-item">
                    <div class="rs-footer-widget footer-1-col-1">
                        <div class="rs-footer-widget-logo">
                            <a href="{{ route('home') }}"><img
                                    src="{{ asset('assets/images/logo/logo-blue-white@4x.png') }}"
                    ...
                    <div class="rs-footer-widget footer-1-col-3">
                        ...
                        <div class="rs-footer-widget-content">
                            ...
                            <form action="{{ route('newsletter.subscribe') }}" method="POST"
                                class="rs-footer-subscribe-form">
                                @csrf
